  ...
  if (!link){
    return(
      <div className='w-3/5 h-12 mx-auto mt-8
        ...
        <p className='text-center mt-1 text-sky-200 font-sans text-2xl'>Something went wrong</p>
      </div>  
    )
    ...
    return(
      <div className='w-3/5 h-12 mx-auto mt-8
        border-solid border-2 border-sky-700 rounded-lg'>
        <p className='text-center mt-1 text-sky-200 font-sans text-2xl'>{process.env.NEXT_PUBLIC_DOMAIN + '/' + link}</p>
      </div>  
    )
  } else {
    return null;
