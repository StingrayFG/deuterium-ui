...
export default function Page() {
  return (
    <div className='bg-gradient-to-b from-black/75 via-transparent to-sky-500/75 h-screen grid'>
      <Image unoptimized src={logo} alt='logo' className='absolute top-0 left-0 pl-4 pt-2 w-16 md:w-24'/>
      <FileUploadPage /> 
      <Link href='https://github.com/StingrayFG/' className='absolute bottom-0 left-0 p-6'>
        <Image unoptimized src={githubMark} alt='githubMark' className='w-10 md:w-16' />
      </Link>
    </div>
  )
}
